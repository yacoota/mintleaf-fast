 ...
 * @Version 1.0
 */
@Api(tags="视频监视相关控制器",description="描述")
@Controller
...
public class StShipinBController {
     ...
     * @return
     */
    @ApiOperation(value="进入视频管理列表页面", notes="描述")
     ...
     * @return
     */
    @ApiOperation(value="进入播放方式页面", notes="描述")
     ...
     * @return
     */
    @ApiOperation(value="进入ckplayer播放页面", notes="描述")
     ...
     * @return
     */
    @ApiOperation(value="进入hlslayer播放页面", notes="描述")
     ...
     * @return
     */
    @ApiOperation(value="更新操作", notes="描述")
